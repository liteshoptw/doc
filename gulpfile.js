...
// 搬移 ./source/fonts 到 ./public/fonts
gulp.task('moveFonts', () =>
...
gulp.task('watch', function () {
  ...
  gulp.watch(['./source/**/*.jade', './source/data/menu.json'], ['jade'])
...
// env
gulp.task('build', gulpSequence('clean', 'jade', 'sass', 'babel', 'vendorsCss', 'VendorJs', 'imageMin', 'moveFonts'))
gulp.task('default', ['jade', 'sass', 'babel', 'vendorsCss', 'VendorJs', 'moveImg', 'moveFonts', 'server', 'watch'])
